...
/* Pumping Station One LEDs
 * some of this code is modified from the Oomlut LED Example from their neat Arduino
 * experimenters kit: http://tinyurl.com/d2hrud
 *
 * Code by Paul Subzak
 * uses Arduino Uno
 */
...
/*
 * fadeCenter() - This will fade the center LED, it's called as fast as the interrupt is called
 */
void fadeCenter() {
